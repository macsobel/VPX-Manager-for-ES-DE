...
const VbsManagerPage = {
    ...
    async render(tableId = null) {
        ...
        container.innerHTML = `
            ...
            <div id="vbs-workspace-container" style="display: flex; gap: 2rem; height: calc(100vh - 200px);">
                <!-- Left: Master List -->
                ...
                <div id="vbs-detail-workspace" style="flex: 2; display: none; flex-direction: column; background: var(--bg-secondary); border-radius: 12px; border: 1px solid var(--border-color); overflow: hidden;">
                    <!-- Detail Header -->
