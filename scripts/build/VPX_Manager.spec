...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['uvicorn', 'fastapi', 'aiosqlite', 'pydantic', 'httpx', 'olefile', 'PIL', 'setproctitle', 'rumps', 'pystray', 'pygame', 'gi', 'gi._gi', 'gi.repository.Gtk', 'gi.repository.Gdk', 'gi.repository.GLib', 'gi.repository.GObject', 'gi.repository.Gio', 'gi.repository.GdkPixbuf', 'gi.repository.Pango', 'gi.repository.AyatanaAppIndicator3', 'jaraco', 'platformdirs'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
